...
function Game(tileNames) {
    ...
    this.flipTile = function(tile) {
        ...
        else
        {
            ...
            {
                if (!this.thirdPick || this.fourthPick) {

                    if (this.fourthPick)
                    {
                        this.thirdPick.flip();
                        this.fourthPick.flip();
                        this.thirdPick = this.fourthPick = undefined;
                    }
        ...
        //
        //     this.firstPick = tile;
        //     this.message = Game.MESSAGE_Three_MORE;
        //
        // }
        // else if(!this.firstPick || !this.secondPick || this.thirdPick)
        // {
        //     if (this.thirdPick)
        //     {
        //         this.firstPick.flip();
        ...
        //     if (this.firstPick === this.secondPick)
        //     {
        //         if (this.secondPick === this.thirdPick)
        //         {
        //             if (this.thirdPick === tile.title)
        //             {
        //                 this.unmatchedPairs--;
        //                 this.message = (this.unmatchedPairs > 0) ? Game.MESSAGE_MATCH : Game.MESSAGE_WON;
        //                 this.firstPick = this.secondPick = undefined;
...
Game.MESSAGE_Three_MORE = 'Pick three more card.'
Game.MESSAGE_Two_MORE = 'Pick two more card.'
Game.MESSAGE_One_MORE = 'Pick three more card.'
